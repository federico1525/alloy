...
var labelCheck = {
  ...
  (function(o, obj){
    result = (o.text==="White label on bg_gray.png background image" && o.color==="white" && o.horizontalWrap===true);
    saveResult(o, obj, result);
  })($.label, labelCheck);
...
var buttonCheck = {
  ...
  (function(o, obj){
    result = (o.bottom==="5" && o.height==="SIZE" && o.horizontalWrap===true && o.title==="click" && o.width==="90%");
    saveResult(o, obj, result);
  })($.button, buttonCheck);
