...
// viewCheck
	...
	(function(o, check) {
		// controls.getProp(o, check);
		if (o.top==="5" && o.backgroundColor==="white" && o.height===50) {
			Ti.API.info("#### " + check.name + " is true");
			check.key = true;
		} else {
			Ti.API.info(check.name + " failed");
...
// labelCheck1
	...
	(function(o, check) {
		// controls.getProp(o, check);
		if (o.text==="BLACK label - WHITE bg" && o.color==="black" && o.font.fontSize==="18dp") {
			Ti.API.info("#### " + check.name + " is true");
			check.key = true;
		} else {
			Ti.API.info(check.name + " failed");
	...
	(function(o, check) {
		// controls.getProp(o, check);
		if (o.bubbleParent===true && o.color==="green" && o.text==="Label and button title defined in XML inline. Styles applied. - Click to close" && o.font.fontSize==="18dp") {
			Ti.API.info("#### " + check.name + " is true");
			check.key = true;
		} else {
			Ti.API.info(check.name + " failed");
	...
	(function(o, check) {
		// controls.getProp(o, check);
		if (o.bubbleParent===true && o.title==="Close" && o.bottom==="5") {
			Ti.API.info("#### " + check.name + " is true");
			check.key = true;
		} else {
			Ti.API.info(check.name + " failed");
